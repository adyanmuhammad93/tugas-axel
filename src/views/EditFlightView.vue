...
const editFlight = async () => {
  ...
  try {
    ...
    const response = await axios.put(`https://fancy-beijinho-1834ec.netlify.app/api/v1/flight/${id}`, formData, {
      headers: {
...
async function fetchFlight() {
  const id = route.params.id
  try {
    const response = await axios.get(`https://fancy-beijinho-1834ec.netlify.app/api/v1/flight/${id}`)
